...
import {View, ScrollView, Alert, Text, Image, StyleSheet, TouchableOpacity} from 'react-native';
            ...
            {data ? <><ScrollView>
                ...
                <View style={styles.container}>
                    <View style={styles.btnInfo}>
                        <TouchableOpacity  onPress={toggleBottomModalSizing} style={styles.btnSisCo}>
                            <Text>Size</Text>
                            <Icon name="menu-down" size={20} />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={toggleBottomModalColor} style={styles.btnSisCo}>
                            <Text>Color</Text>
                            <Icon name="menu-down" size={20} />
                        </TouchableOpacity>
                    ...
                    <View style={styles.infoContainer}>
                        ...
                        <TouchableOpacity style={[styles.sizeShipping, styles.sizeSupport]}>
                ...
                <View style={styles.modalSize}>
                    ...
                    <View style={styles.bottomModalSize}>
                        <TouchableOpacity onPress={() => setSelectedSize('XS')} style={styles.btnSizing}>
                            <Text>XS</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => setSelectedSize('S')} style={styles.btnSizing}>
                            <Text>S</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => setSelectedSize('M')} style={styles.btnSizing}>
                            <Text>M</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => setSelectedSize('L')} style={styles.btnSizing}>
                            <Text>L</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => setSelectedSize('XL')} style={styles.btnSizing}>
                            <Text>XL</Text>
                        </TouchableOpacity>
                    </View>
                    <TouchableOpacity style={styles.sizeInfo} onPress={toggleBottomModalSizing}>
